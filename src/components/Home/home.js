...
import './css/demo.css';
import './css/gaia.css';
import Clinical from './img/clinical.jpg';
import Bogdan from './img/bogdan.webp';
...
const Home = () => {
            ...
            <div className="container">
                <div className="content">
                    ...
                    <div className="title-area">
                        <h1 className="title-modern">Hey</h1>
                        <h3>We are here to make the process of recruting faster</h3>
                        <div className="separator line-separator">♦</div>
                    </div>

                    <div className="button-get-started">
                        <a href="/contact" target="_blank" className="btn btn-white btn-fill btn-lg ">
                            Register today
                        </a>
                    </div>
    ...
    <div className="section section-our-clients-freebie">
        <div className="container">
            <div className="title-area">
                <h5 className="subtitle text-gray"></h5>
    ...
    <div className="section section-our-team-freebie">
        ...
        <div className="image" style={{backgroundImage: "url('./img/back4.webp')"}}>
            </div>
         <div className="container">
            <div className="row">
                <div className="title-area">
...
<div className="section section-our-clients-freebie">
        <div className="container">
            <div className="title-area">
                <h5 className="subtitle text-gray"></h5>
                <h2>How we make the recruitment process faster?</h2>
                <div className="separator separator-danger">✻</div>
            </div>
    ...
    <div className="section section-our-team-freebie">
        <div className="parallax filter filter-color-black">
            <div className="image" style={{backgroundImage: "url('./img/back3.jpg')"}}>
            </div>
            <div className="container">
                <div className="content">
                    <div className="row">
                    ...
                    <div className="team">
                        <div className="row">
                            <div className="col-md-12 col-lg-12 col-xl-12 col-md-offset-1">
                                <div className="row">
                                <div className="col-md-2 col-lg-2 col-xl-2">
                                        ...
                                        <div className="card card-member">
                                            <div className="content">
                                                <div className="avatar avatar-danger">
                                                    <img alt="..." className="img-circle" src={require("./img/bogdan.webp")}/>
                                                </div>
                                                <div className="description">
                                                    <h3 className="title">Andrew</h3>
                                                    <p className="small-text"> Co-Founder</p>
                                    ...
                                    <div className="col-md-4 col-lg-4 col-xl-4">
                                        <div className="card card-member">
                                            <div className="content">
                                                <div className="avatar avatar-danger">
                                                    <img alt="..." className="img-circle" src={require("./img/grigorina.jpg")}/>
                                                </div>
                                                <div className="description">
                                                    <h3 className="title">Andrew</h3>
                                                    <p className="small-text">Co-Founder</p>
    ...
    <div className="section section-small section-get-started">
        <div className="parallax filter">
            <div className="image"
            style={{backgroundImage: "url('./img/back1.jpg')"}}
                >
            </div>
            <div className="container">
                <div className="title-area">
